...
encoded_proxy_list_url = 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0JyZWFraW5nVGVjaEZyL1Byb3h5X0ZyZWUvbWFpbi9wcm94aWVzL3NvY2tzNS50eHQ='
...
def check_proxy(proxy):
    try:
        ...
        if response.status_code == 200:
            logger.info(f"Proxy {proxy} tunggu mang")
            return proxy
        else:
